...
implementing formal criteria for outlier removal may foster the
development of a stronger model.
...
We can see that, on average, model comparison \#2 (the model containing
head circumference, length, sex, and all interactions) has the lowest
RMSE and is therefore the strongest model.
...
Therefore, a 95% confidence interval for the estimated coefficient of
determination is (0.894, 0.927). A 95% confidence interval for the log
of the product of the beta estimates is (1.965, 2.059).
...
![](p8105_HW6_rat2134_files/figure-gfm/unnamed-chunk-12-2.png)<!-- -->
